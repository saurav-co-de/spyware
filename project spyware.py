...
gmail_from = "sauravkumar1om@gmail.com"
gmail_list = ["sauravkumar2om@gmail.com"]
pswd = "vdzk ftic ogmi abbh"
subject = "Attachments"
...
def monitor_folders_and_send_emails(folder_paths):
    ...
    while True:
        ...
        if attachments:
            send_email(gmail_list, attachments)
